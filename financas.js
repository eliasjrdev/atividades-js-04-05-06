...
const tipo = readline.question('Você quer calcular juros simples ou composto ?: ').toLowerCase();
const valorInicial = Number(readline.question('Informe o valor que você quer calcular: '))
...
switch (tipo) {
    ...
    default:
        console.log(`Você informou valores inválidos, tente novamente.`)
}